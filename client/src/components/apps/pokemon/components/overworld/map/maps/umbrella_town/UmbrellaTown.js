        ...
        [asGridCoords(36, 74)]: [
            {
                events: [
                    ...
                    { type: "textMessage", text: "Green: Tiens tiens..." },
                    { type: "textMessage", text: "Green: Comment on se retrouve ?" },
                    { type: "textMessage", text: "Green: C'est marrant je viens de retomber sur le vilain Mimiqui." },
                    { type: "textMessage", text: "Green: Il était un peu traumatisé quand il m'a vu." },
                    { type: "textMessage", text: "Green: Je crois qu'il n'a pas trop apprécié notre dernière rencontre." },
                    { who: "rivalA", type: "walk", direction: "down"},

                    { type: "textMessage", text: "Green: Tu m'as l'air un peu fatigué." },
                    { type: "textMessage", text: "Green: L'occasion parfaite pour te mettre une raclée." },
                    
                    { type: "battle", enemyId: "rivalB" },
                    { type: "textMessage", text: "Green: Je ne comprends pas!" },
                    { type: "textMessage", text: "Green: Mes Pokémons sont nuls." },
                    { type: "textMessage", text: "Green: Voià tout." },
                    { type: "textMessage", text: "Green: Pff..." },
                    { type: "textMessage", text: "Green: Je devrais rejoindre la Team Rocket pour devenir plus fort." },
                    { type: "textMessage", text: "Green: Je crois que leur repaire est dans cette ville." },
        ...
        [asGridCoords(62, 18)]: [
            {
                events: [
                    ...
                    { type: "textMessage", text: "Green: Pourquoi te mettrais tu en travers de ma route?" },
                    { type: "textMessage", text: "Vlad: Je ne supporte pas qu'on maltraite un Pokémon." },
                    { type: "textMessage", text: "Green: Peut on encore le considérer ainsi?" },
                    ...
                    { type: "textMessage", text: "Green: T'es encore là toi!" },
                    { type: "textMessage", text: "Green: Je suis bien plus fort que la dernière fois!" },
                    ...
                    { type: "textMessage", text: "Green: Pff c'est ridicule!" },
                    { type: "textMessage", text: "Green: Tu n'as aucune chance!" },

                    { type: "battle", enemyId: "rivalC" },
                    
                    { type: "textMessage", text: "Green: Je ne comprends pas." },
                    { type: "textMessage", text: "Green: Mon Pikachad est pourtant niveau 11." },
                    { who: "rivalB", type: "stand", direction: "down", time: 1500},
                    { type: "textMessage", text: "Green: A plus les nazes!" },
